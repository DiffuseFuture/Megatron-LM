...
from megatron.core.transformer import MLATransformerConfig, TransformerConfig, WanTransformerConfig
...
def core_transformer3d_config_from_args(args, config_class=None):
